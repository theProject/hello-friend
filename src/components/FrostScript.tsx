        ...
        <div className={`${getGlassMessage} p-4`}>
          <div className="flex flex-nowrap justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-3 group">
              <div
                className={`transform transition duration-300 group-hover:scale-110 group-hover:rotate-12`}
              >
                <FaConnectdevelop
                ...
                />
                 ...
                 {/* Effects for the logo lettering only */}
              <h1
...
>
  Hello Friend.              
            ...
            <div className="flex items-center gap-2">
              {/* File Upload Button */}
              <label
                className={`p-2 transform transition-all duration-300 hover:scale-110 hover:rotate-12 hover:bg-opacity-40`}
              >
                <input
                  ref={fileInputRef}
                  type="file"
      ...
      >
        ...
        {isGeneratingImage && (
          <div
            className={`${getGlassStyle} flex flex-col items-center gap-2 p-4 rounded-xl`}
          >
      ...
      {selectedImage && (
        <ImageModal
          ...
          onDownload={() =>
            selectedImage.url && handleImageDownload(selectedImage.url)
          }
          glassStyle={getGlassStyle}
        />
      )}
