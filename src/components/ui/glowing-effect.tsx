...
const GlowingEffect = memo(
  ({
    ...
    return (
      <>
        {/* The static wrapper can remain as is */}
        ...
        <div
          ...
          className={cn(
            ...
            className,
            disabled && "!hidden",
            // Set dynamic CSS custom properties via Tailwind’s arbitrary value syntax.
            `[--blur:${blur}px]`,
            `[--spread:${spread}]`,
            `[--start:0]`,
            `[--active:0]`,
            ...
            variant === "white"
              ? `[--gradient:repeating-conic-gradient(from 236.84deg at 50% 50%,var(--black),var(--black) calc(25%/var(--repeating-conic-gradient-times)))]`
